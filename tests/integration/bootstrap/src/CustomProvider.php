 ...
 */
final class CustomProvider implements CommandProviderInterface, IteratorAggregate
{
    public function getIterator(): Traversable
    {
        // Simulate providing a command that cannot be loaded by the autoloader
        yield new class ('db:anonymous') extends Command {
            ...
            {
                $output->writeln('Anonymous class reporting for duty.');
